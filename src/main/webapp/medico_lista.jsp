	...
	<body>
		...
		<div class="container py-3">
			...
			<main class="form-signin">
				<div class="">
					<form class="card p-2" id="form-pesquisa" action="pesquisar_medico" method="post">
					...
					<div class="card">
						<div class="card-header">
				        	<b>Médicos Cadastrados</b> <a href="cadastrar_medico" class="btn btn-sm btn-primary"><i class="fa fa-file-text-o"></i>Cadastrar Médico</a>
				        </div>
				        
						<!-- /.card-header -->
						<div class="card-body">
							<table id="lista-medico" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th width="40%">Nome</th>
										...
										<tr>
											...
											<td align="center">
												<form action="#" method="post" id="form-lista">
													...
													<button type="button" class="btn btn-sm btn-primary" onclick="editar('${medico.id}')">Editar</button>
													<button type="button" class="btn btn-sm btn-danger" onclick="excluir('${medico.id}')">Excluir</button>
												</form>
											</td>
										</tr>
									</c:forEach>
		...
		<script type="text/javascript">
			...
			function editar(value) {
				document.getElementById('idMedico').value = value;

				var form = document.forms['form-lista'];
				form.action = "editar_medico";
				form.submit();
			}
