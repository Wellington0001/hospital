	...
	<body>
		...
		<div class="container py-3">
			...
			<main class="form-signin">
				<div class="">
					<form class="card p-2" id="form-pesquisa" action="pesquisar_paciente" method="post">
					...
					<div class="card">
						<div class="card-header">
				        	<b>Pacientes Cadastrados</b> <a href="cadastrar_paciente" class="btn btn-sm btn-primary"><i class="fa fa-file-text-o"></i>Cadastrar Paciente</a>
				        </div>
				        
						<!-- /.card-header -->
						<div class="card-body">
							<table id="lista-paciente" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th width="50%">Nome</th>
										<th width="30%">CPF</th>
										...
										<tr>
											...
											<td align="center">
												<form action="#" method="post" id="form-lista">
													<input type="hidden" id="idPaciente" name="idPaciente" value="${paciente.id}">

													<button type="button" class="btn btn-sm btn-primary" onclick="editar('${paciente.id}')">Editar</button>
													<button type="button" class="btn btn-sm btn-danger" onclick="excluir('${paciente.id}')">Excluir</button>
												</form>
											</td>
										</tr>
									</c:forEach>
		...
		<script type="text/javascript">
			...
			function editar(value) {
				document.getElementById('idPaciente').value = value;

				var form = document.forms['form-lista'];
				form.action = "editar_paciente";
				form.submit();
			}
